    ...
    >
      ...
      {status === 'checking' && (
        <>
          ...
          <p className="text-sm" style={{ color: '#8E8E93' }}>{t('Onboarding.inviteChecking')}</p>
        </>
      )}
      ...
      {status === 'success' && (
        <>
          ...
          <h2 className="text-xl font-black mb-2" style={{ color: '#1C1C1E' }}>{t('Onboarding.inviteSuccess')}</h2>
          <p className="text-sm mb-1" style={{ color: '#8E8E93' }}>{t('Onboarding.inviteWelcome')}</p>
          <p className="text-xs" style={{ color: '#636366' }}>{t('Onboarding.inviteRedirect')}</p>
        </>
      )}
      ...
      {status === 'invalid' && (
        <>
          ...
          <h2 className="text-xl font-black mb-2" style={{ color: '#1C1C1E' }}>{t('Onboarding.inviteInvalid')}</h2>
          <p className="text-sm mb-6" style={{ color: '#8E8E93' }}>
            {t('Onboarding.inviteExpired')}
          </p>
          <button
