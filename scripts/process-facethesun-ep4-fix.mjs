...
const TS = { width: 1614, height: 2048 }

// Corrected ep4 coords: top=880 (was 870), h=170 (was 217)
const CARDS = [
  { versionId: 'V_KR016_04', detail: 'Photocard 1', left: 76,  top: 880, width: 108, height: 170 },
  { versionId: 'V_KR016_04', detail: 'Photocard 2', left: 190, top: 880, width: 107, height: 170 },
  { versionId: 'V_KR016_04', detail: 'Photocard 3', left: 305, top: 880, width: 107, height: 170 },
  { versionId: 'V_KR016_04', detail: 'Photocard 4', left: 420, top: 880, width: 107, height: 170 },
]
...
for (const file of files) {
  ...
  for (const c of CARDS) {
    const { data: rows } = await s.from('card_master').select('id').eq('version_id', c.versionId).eq('member_id', mid).eq('card_type', 'photocard').ilike('card_detail', c.detail)
